...
{	//public protected 
	...
	public function uploadprofileimage(Request $request){
		$validator = Validator::make($request->all(),
		  [ 
			'uploadimage'    => 'required|image|mimes:jpeg,bmp,png'
			]
		 )->validate();
		$uploadsong_img=$request->uploadimage;
		if($uploadsong_img){
			...
			$url = $this->getsharelink($imagepath);
	...
	public function uploadsong(Request $request)
	{
		...
		if($uploadsong_img){
			...
			$imagepath =  $this->Uploadimagetodropbox($dropboxPath, $sourcePath);
			$songs->image   = $this->getsharelink($imagepath);
			...
			$imagepath =  $this->Uploadimagetodropbox($dropboxPath, $sourcePath);
			$songs->source   = $this->getsharelink($imagepath);
